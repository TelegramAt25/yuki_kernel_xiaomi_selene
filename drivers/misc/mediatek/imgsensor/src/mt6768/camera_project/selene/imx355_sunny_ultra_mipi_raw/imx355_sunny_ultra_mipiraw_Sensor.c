...
#include "imx355_sunny_ultra_mipiraw_eeprom.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355_SUNNY_ULTRA_SENSOR_ID,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx355sunny_table_write_cmos_sensor(addr_data_pair_video_imx355sunny,
	sizeof(addr_data_pair_video_imx355sunny) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif
#ifdef IMX355_PDAF_SUPPORT
...
UINT32 IMX355_SUNNY_ULTRA_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
