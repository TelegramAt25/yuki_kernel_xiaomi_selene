...
#include "ov13b10_ofilm_mipiraw_Sensor.h"
#include "cam_cal_define.h"
#define PFX "OV13B10_OFILM_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_OFILM_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(addr_data_pair_init_ov13b10,
					sizeof(addr_data_pair_init_ov13b10) /
					sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
static void preview_setting(void)
{
	...
	ov13b10_table_write_cmos_sensor(addr_data_pair_preview_ov13b10,
					sizeof(addr_data_pair_preview_ov13b10) /
					sizeof(kal_uint16));
#else
//      write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_video_ov13b10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_hs_video_ov13b10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_slim_video_ov13b10,
					sizeof
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_ov13b10_ofilm[] = {
	//      0x0100, 0x00,
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custom1_ov13b10_ofilm,
		sizeof(addr_data_pair_custom1_ov13b10_ofilm) /
		sizeof(kal_uint16));
#else
	//      write_cmos_sensor(0x0100, 0x00);
...
#define OV13B10_OFILM_MODULE_ID  0x07
...
{
	return (2 + ((read_cmos_sensor(0x300a) << 16) |
...
UINT32 OV13B10_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
