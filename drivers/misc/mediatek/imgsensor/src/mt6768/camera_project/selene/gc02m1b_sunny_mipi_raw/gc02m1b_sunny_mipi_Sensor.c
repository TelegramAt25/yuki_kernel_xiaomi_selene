...
#include "gc02m1b_sunny_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "GC02M1B_SUNNY"
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	...
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0000, 0000, 1600, 1200, 0, 0, 1600, 1200}  /* custom1 30fps */
};
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	LOG_DBG("GC02M1B_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
...
UINT32 GC02M1B_SUNNY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
