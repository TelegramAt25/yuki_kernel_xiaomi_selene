...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B1B_OFILM_SENSOR_ID,
...
static void ov02b1b_read_otp(void)
{
...
UINT32 OV02B1B_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
