...
int mt6768_print_register(struct mtk_base_afe *afe)
{
	...
	dev_dbg(afe->dev, "AFE_DAC_CON1 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_BUS_MON0 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_DAC_CON2 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_IRQ_MCU_EN1 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_IRQ1_MCU_EN_CNT_MON = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_MEMIF_MINLEN = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_MEMIF_MAXLEN, &value);
	dev_dbg(afe->dev, "AFE_MEMIF_MAXLEN = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_MEMIF_PBUF_SIZE, &value);
	dev_dbg(afe->dev, "AFE_MEMIF_PBUF_SIZE = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_APLL_TUNER_CFG = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_MEMIF_HD_MODE, &value);
	dev_dbg(afe->dev, "AFE_MEMIF_HD_MODE = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_MEMIF_HDALIGN, &value);
	dev_dbg(afe->dev, "AFE_MEMIF_HDALIGN = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_DL1_D2_BASE_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL1_D2_CUR_MSB, &value);
	dev_dbg(afe->dev, "AFE_DL1_D2_CUR_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_DL1_D2_END_MSB, &value);
	dev_dbg(afe->dev, "AFE_DL1_D2_END_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_VUL_D2_BASE_MSB, &value);
	dev_dbg(afe->dev, "AFE_VUL_D2_BASE_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_VUL_D2_END_MSB, &value);
	dev_dbg(afe->dev, "AFE_VUL_D2_END_MSB = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_VUL_D2_CUR_MSB, &value);
	dev_dbg(afe->dev, "AFE_VUL_D2_CUR_MSB = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_ADDA_MTKAIF_TX_CFG1 = 0x%x\n", value);
			       ...
			       struct snd_ctl_elem_value *ucontrol)
{
	...
	sph_property = (int *)get_sph_property_by_name(afe_priv,
						       kcontrol->id.name);
	if (!sph_property) {
		dev_dbg(afe->dev, "%s(), sph_property == NULL\n", __func__);
		return -EINVAL;
	}
